...
export const brand: Brand = {
  name: "Pure Relief Spa",
  shortName: "Pure Relief",
  microTag: "LUXURY MASSAGE AND WELLNESS",
  description:
    "Pure Relief Spa is a Accra massage studio built around one promise: you leave lighter than you came.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0203906500",
    phoneTel: "+233203906500",
    textPhone: "0203906500",
    textPhoneTel: "+233203906500",
    email: "hello@purerelief.test",
    privacyEmail: "privacy@purerelief.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@purereliefspa_accra", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "At Pure Relief Spa, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "Pure Relief Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Pure Relief Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Pure Relief Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Pure Relief Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Pure Relief Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Pure Relief Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Pure Relief Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Pure Relief Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Pure Relief Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Pure Relief Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@purereliefspa_accra",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489373/stage4/spa_purereliefspaaccra/tiktok_0.mp4",
        alt: "Pure Relief Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489376/stage4/spa_purereliefspaaccra/tiktok_1.mp4",
        alt: "Pure Relief Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Pure Relief Spa salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Pure Relief Spa self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Pure Relief Spa studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Pure Relief Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Pure Relief Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0203906500 and text 0203906500 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0203906500, text 0203906500, or message @purereliefspa_accra on Instagram." },
          ...
          { q: "Where are you located?", a: "Pure Relief Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@purerelief.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Pure Relief Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@purerelief.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Pure Relief Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@purerelief.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Pure Relief Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0203906500", href: "tel:+233203906500" },
      { label: "Text", value: "0203906500", href: "sms:+233203906500" },
      { label: "Instagram", value: "@purereliefspa_accra", href: "https://www.tiktok.com/@purereliefspa_accra" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783489370/stage4/spa_purereliefspaaccra/avatar.jpg",
    blurb:
      "Pure Relief Spa in Accra — luxury massage and wellness.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@purereliefspa_accra" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0203906500", href: "tel:+233203906500" },
          { label: "Text 0203906500", href: "sms:+233203906500" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Pure Relief Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
