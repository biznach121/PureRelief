...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#4b4700] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#595000]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(48, 43, 0,0.58),rgba(70, 55, 0,0.22)_43%,rgba(50, 46, 0,0.34)),linear-gradient(0deg,rgba(25, 24, 0,0.18),rgba(25, 24, 0,0.08))]" />
